...
#准备部分必须命令
curl -soL ${SCRIPT}/command.sh 'https://gitee.com/youngdriver/bootanimation/raw/master/command.sh'
source ${SCRIPT}/command.sh
...
[ $DPI == stretch -o $DPI == fill ] || PAD=",pad=${UW}:${UH}:${SW}:${SH}:color=${COLOR}"
